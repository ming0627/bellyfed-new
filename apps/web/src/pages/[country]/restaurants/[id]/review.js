...
const mockRestaurantData = {
  ...
  imageUrl:
    'https://images.unsplash.com/photo-1627308595171-d1b5d95d051d?q=80&w=200&h=200&fit=crop',
  rating: 4.5,
  reviewCount: 256,
  priceRange: '$$',
  cuisine: 'Malaysian',
...
const mockDishData = {
  ...
  description:
    'Traditional Malaysian coconut rice served with crispy fried chicken, sambal, fried anchovies, peanuts, cucumber slices, and a boiled egg.',
  imageUrl:
    'https://images.unsplash.com/photo-1627308595171-d1b5d95d051d?q=80&w=200&h=200&fit=crop',
  price: 'RM 12.90',
  currency: 'RM',
...
export default function ReviewSubmissionPage() {
  ...
  if (restaurantError) {
    return (
      <Layout title="Error" description="Error loading restaurant details">
        <div className="container mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col items-center justify-center min-h-[60vh]">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center max-w-md">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                We encountered a problem while loading the restaurant details.
