...
import { Camera, Edit, MapPin, Calendar, Award, MessageSquare, Star } from 'lucide-react';
      ...
      >
        ...
        {isCurrentUser && isHoveringCover && (
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            ...
            >
              <LucideClientIcon icon={Camera} className="w-5 h-5 mr-2" aria-hidden="true" />
              Change Cover
            </button>
          </div>
        )}
        ...
        {isCurrentUser && (
          ...
          >
            <LucideClientIcon icon={Edit} className="w-5 h-5" aria-hidden="true" />
          </button>
        )}
      </div>
        ...
        >
          ...
          {isCurrentUser && isHoveringAvatar && (
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                <LucideClientIcon icon={Camera} className="w-5 h-5" aria-hidden="true" />
              </button>
            </div>
          )}
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600 dark:text-gray-400">
            {user.location && (
              <div className="flex items-center">
                <LucideClientIcon icon={MapPin} className="w-4 h-4 mr-1" aria-hidden="true" />
        ...
        <div className="grid grid-cols-3 gap-4 border-t border-gray-200 dark:border-gray-700 pt-6">
          <div className="text-center">
            <div className="flex items-center justify-center mb-1">
              <LucideClientIcon icon={Star} className="w-5 h-5 text-orange-500 mr-1" aria-hidden="true" />
              <span className="text-xl font-bold text-gray-900 dark:text-white">{user.reviewCount || 0}</span>
            </div>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-1">
              <LucideClientIcon icon={MessageSquare} className="w-5 h-5 text-orange-500 mr-1" aria-hidden="true" />
              <span className="text-xl font-bold text-gray-900 dark:text-white">{user.commentCount || 0}</span>
            </div>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-1">
              <LucideClientIcon icon={Award} className="w-5 h-5 text-orange-500 mr-1" aria-hidden="true" />
              <span className="text-xl font-bold text-gray-900 dark:text-white">{user.badgeCount || 0}</span>
            </div>
