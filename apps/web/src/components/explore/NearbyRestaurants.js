...
const NearbyRestaurants = memo(function NearbyRestaurants({
  ...
  const filteredAndSortedRestaurants = [...restaurants]
    ...
    .filter(restaurant => {
      ...
      if (filters.cuisines.length > 0 && !restaurant.cuisineTypes?.some(cuisine => filters.cuisines.includes(cuisine))) {
        return false;
      }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="ms-3 text-sm font-medium text-gray-700 dark:text-gray-300">Open Now</span>
                </label>
              </div>
            </div>
          </div>
          ...
          filteredAndSortedRestaurants.map((restaurant) => (
            <div
              ...
              className={`p-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors cursor-pointer ${
                selectedRestaurantId === restaurant.id ? 'bg-orange-50 dark:bg-orange-900/20' : ''
              }`}
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        <div className="flex items-center">
                          <LucideClientIcon icon={Star} className="w-4 h-4 text-yellow-400" aria-hidden="true" />
                    ...
                    <div className="flex items-center text-sm">
                      <LucideClientIcon icon={MapPin} className="w-4 h-4 text-orange-500 mr-1" aria-hidden="true" />
                      <span className="text-gray-600 dark:text-gray-400">{restaurant.distance}</span>
                    </div>
                  </div>
