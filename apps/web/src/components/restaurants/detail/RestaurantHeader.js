        ...
        <div className="flex justify-between items-start">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-y-2">
              {restaurant.rating && (
                <div className="flex items-center mr-4">
                  <LucideClientIcon icon={Star} className="h-4 w-4 text-yellow-400 mr-1" />
            ...
            <div className="mt-3 flex flex-wrap gap-y-2">
              {restaurant.address && (
                <div className="flex items-center mr-4 text-sm text-white/80">
                  <LucideClientIcon icon={MapPin} className="h-4 w-4 mr-1.5" />
              ...
              {restaurant.phone && (
                <div className="flex items-center mr-4 text-sm text-white/80">
                  <LucideClientIcon icon={Phone} className="h-4 w-4 mr-1.5" />
              ...
              {restaurant.website && (
                <div className="flex items-center mr-4 text-sm text-white/80">
                  <LucideClientIcon icon={Globe} className="h-4 w-4 mr-1.5" />
                  <span>Website</span>
                </div>
              )}
              ...
              {restaurant.hours && restaurant.hours.status && (
                <div className="flex items-center text-sm">
                  <LucideClientIcon icon={Clock} className="h-4 w-4 mr-1.5" />
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              aria-label="Share"
            >
              <LucideClientIcon icon={Share2} className="h-5 w-5" />
            </button>
          </div>
        </div>
      </div>
