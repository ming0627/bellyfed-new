          ...
          <ul className="space-y-3">
            {restaurant.cuisine && (
              <li className="flex items-start">
                <Utensils className="h-5 w-5 text-orange-500 mr-2 mt-0.5" />
                <div>
            ...
            {restaurant.priceRange && (
              <li className="flex items-start">
                <DollarSign className="h-5 w-5 text-orange-500 mr-2 mt-0.5" />
                <div>
                  <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    Price Range
                  </span>
          ...
          <div>
            ...
            {restaurant.hours.notes && (
              <div className="mt-3 text-sm text-gray-600 dark:text-gray-400 flex items-start">
                <Clock className="h-4 w-4 text-orange-500 mr-1.5 mt-0.5" />
