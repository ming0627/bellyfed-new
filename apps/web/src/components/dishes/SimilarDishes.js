            ...
            >
              <div className="w-16 h-16 rounded-md overflow-hidden flex-shrink-0 bg-gray-200 dark:bg-gray-700">
                {dish.imageUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <LucideClientIcon icon={Utensils} className="w-6 h-6 text-gray-400" />
                  </div>
                )}
              </div>
              ...
              <div className="ml-3">
                ...
                <div className="flex items-center mt-1">
                  {dish.rating && (
                    <>
                      <LucideClientIcon icon={Star} className="w-4 h-4 text-yellow-400 fill-current" aria-hidden="true" />
