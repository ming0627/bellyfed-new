          ...
          {[1, 2, 3, 4, 5].map((level) => (
            <div
              ...
              className={`h-1.5 flex-grow rounded-full ${
                level <= strength ? getStrengthColor(strength) : 'bg-gray-300 dark:bg-gray-700'
              }`}
            ></div>
          ))}
        </div>
        ...
        <div className="text-xs text-gray-600 dark:text-gray-400 space-y-1 mt-2">
          <div className="flex items-center">
            <LucideClientIcon
              ...
              className={`w-3.5 h-3.5 mr-1.5 ${
                password.length >= 8 ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'
              }`}
              aria-hidden="true"
            />
          ...
          <div className="flex items-center">
            <LucideClientIcon
              ...
              className={`w-3.5 h-3.5 mr-1.5 ${
                /[A-Z]/.test(password) ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'
              }`}
              aria-hidden="true"
            />
          ...
          <div className="flex items-center">
            <LucideClientIcon
              ...
              className={`w-3.5 h-3.5 mr-1.5 ${
                /[0-9]/.test(password) ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'
              }`}
              aria-hidden="true"
            />
            <span>Number</span>
          ...
          <div className="flex items-center">
            <LucideClientIcon
              ...
              className={`w-3.5 h-3.5 mr-1.5 ${
                /[^A-Za-z0-9]/.test(password) ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'
              }`}
              aria-hidden="true"
            />
          ...
          <div>
            ...
            {formData.confirmPassword && (
              <div className="mt-2 flex items-center">
                <LucideClientIcon
                  icon={formData.password === formData.confirmPassword ? Check : AlertCircle}
