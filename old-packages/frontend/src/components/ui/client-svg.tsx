...
/**
 * ClientSVG component that renders SVG elements only on the client side.
 * This helps prevent hydration errors when SVG elements have dynamic attributes.
 *
 * @param viewBox SVG viewBox attribute
 * @param children SVG child elements (paths, etc.)
...
export const Icons = {
  ...
  Verified: (props: React.SVGProps<SVGSVGElement>) => (
    <ClientSVG viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" />
    </ClientSVG>
  ),

  CopyLink: (props: React.SVGProps<SVGSVGElement>) => (
    <ClientSVG viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth={2}
