...
export default function GlobalDishRankingPage(): JSX.Element {
          ...
          <Tabs defaultValue="global" className="w-full">
            ...
            <TabsContent value="global">
              {isLoading ? (
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Global Rankings for {dishData.name}</CardTitle>
                    <CardDescription>
                      See how this dish ranks worldwide
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center py-8">
                      <p className="text-gray-500 mb-4">
                        Global rankings will be implemented in Phase 4.
                      </p>
                      <p className="text-sm text-gray-400">
                        Check back soon for global rankings!
                      </p>
                    </div>
                  </CardContent>
                </Card>
