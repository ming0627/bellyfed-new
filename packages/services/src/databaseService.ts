/**
 * Database Service
 * Handles interactions with the database through the PostgreSQL service
 */

import { cognitoAuthService } from './auth/cognitoAuthService.js';
import { postgresService, RankingStats, VoteStats } from './postgresService.js';
...
export class DatabaseService {
   ...
   * @param tasteStatus The taste status
   * @param notes Notes about the dish
   * @param photoUrls URLs of photos
