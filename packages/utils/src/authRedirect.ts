...
import type { NextRouter } from './types/next.js';
...
/**
 * Options for redirect functions
 */
export interface RedirectOptions {
  ...
  /**
   * Optional message to display on the authentication page
   */
  message?: string;
  ...
  /**
   * Default path to redirect to if no returnUrl is provided
   */
  defaultPath?: string;
}
